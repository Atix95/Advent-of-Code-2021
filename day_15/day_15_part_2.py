...
def create_5x5_tile_cave(risk_levels):
    x_max_tile = len(risk_levels[0])
    y_max_tile = len(risk_levels)
...
if __name__ == "__main__":
    ...
    entire_cave = create_5x5_tile_cave(risk_levels)

    print("\n".join(str(line) for line in entire_cave))

    lowest_risk = find_path_with_lowest_risk(entire_cave)
    print(lowest_risk)
